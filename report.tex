...
\midrule
Member 1 & Preprocessing pipeline, TF-IDF vectorization, corpus design \\
Member 2 & K-Means clustering, silhouette analysis, PCA visualization \\
Member 3 & Semantic embeddings (SBERT + PCA), optimization experiments \\
Member 4 & TextRank summarization, LDA topic modeling, UI/Streamlit \\
\bottomrule
\end{tabular}
\end{table}
